...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		var a = typeof exports === 'object' ? factory(require("omi")) : factory(root["omi"]);
...
var _swiper3 = __webpack_require__(4);
...
(0, _omi.define)('o-swiper', function (_WeElement) {
  ...
  function _class2() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _class2.__proto__ || Object.getPrototypeOf(_class2)).call.apply(_ref, [this].concat(args))), _this), _this.name = 'Swiper', _this.installed = function () {
      var _this$props$data = _this.props.data,
          swiper = _this$props$data.swiper,
          getCase = _this$props$data.getCase,
          name = _this$props$data.name;

      var instance = new _swiper2['default']('#' + name, Object.assign({}, swiper ? swiper : {}));
      if (getCase) getCase(instance);
    }, _this._nav = function (navigation) {
      var nextEl = navigation.nextEl,
  ...
  _createClass(_class2, [{
    key: 'css',
    value: function css() {
      return _swiper4['default'];
    }
  }, {
    key: 'render',
    value: function render(props) {
      var _props$data = props.data,
          imgs = _props$data.imgs,
          swiper = _props$data.swiper,
          name = _props$data.name;

      return Omi.h(
        'div',
        _extends({ id: name }, (0, _omi.extractClass)(props, "swiper-container")),
        Omi.h(
          'div',
          { 'class': 'swiper-wrapper' },
          imgs ? imgs.map(function (item, index) {
            return item.html ? item.html : Omi.h(
              'div',
              { 'class': 'swiper-slide' },
              Omi.h('img', { src: item.src })
            );
          }) : null
        ),
        swiper['scrollbar'] ? Omi.h(
          'div',
          { 'class': 'swiper-scrollbar' },
          ' '
        ) : null,
        swiper['navigation'] ? this._nav(swiper['navigation']) : null,
        swiper['pagination'] ? Omi.h(
          'div',
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/dist/cjs.js!./_swiper.css", function() {
		var newContent = require("!!../../node_modules/css-loader/dist/cjs.js!./_swiper.css");
